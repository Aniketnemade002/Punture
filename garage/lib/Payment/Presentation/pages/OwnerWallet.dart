      ...
      child: Container(
        ...
        child: LiquidPullToRefresh(
          ...
          onRefresh: () async {
            ...
            paymentBloc.add(OwnerFetchBalance());
          },
          child: Scaffold(
                          ...
                          RichText(
                            ...
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(
                                  text:
                                      ' Withdraw your Ammount ! ', // Text next to the icon
                                  style: TextStyle(
                                    color: Kcolor.TextB,
                                    fontFamily: fontstyles.Gpop,
...
class PaymentSuccessDialog extends StatelessWidget {
  ...
  const PaymentSuccessDialog({super.key, required this.cost});
  @override
  Widget build(BuildContext context) {
    return AlertDialog(
      backgroundColor: Kcolor.bg,
