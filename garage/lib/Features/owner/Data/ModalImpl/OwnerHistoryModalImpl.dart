...
import 'package:garage/Features/owner/Domain/Entity/Booking.dart';

class OwnerHistoryModal extends OwnerBookingData {
  OwnerHistoryModal(
  ...
  factory OwnerHistoryModal.fromJson(DocumentSnapshot doc) {
    Map json = doc.data() as Map;
    return OwnerHistoryModal(
